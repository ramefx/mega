/*
 * P06_1_PWMF_Timer_Servo.c
 *
 * Created: 26/09/2017 11:03:55 a. m.
 * Author : a
 */ 
...
void conf_Timer1(){
	...
	TCCR1C=(0<<FOC1A)|(0<<FOC1B);//no forzamos ninguna salida, porque estamos utilizando PWM (son para forzar salidas por canal A o B)
	
	TCNT1=0x00;//inicimos el timer a cero
	
	ICR1=36863;//TOP con prescaler de 8 N=8 50hz 
	
	OCR1A=1843;//5% al origen /iniciara en 70% de ciclo util 25804|/| estamos utilizando el 50% 18432 |/|si se asigna como top varia frecuencia y el cliclo util, salida OC1A -> PB1
